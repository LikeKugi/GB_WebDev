...
$occupations = [
    [
        ...
        'started' => 'Jan 2015',
        'ended' => null,
        'about' => 'Lorem ipsum dolor sit amet. Praesentium magnam consectetur vel in deserunt aspernatur est reprehenderit
    ...
    <div class="w3-row-padding">
        ...
        <div class="w3-twothird">
            <div class="w3-container w3-card w3-white w3-margin-bottom">
                ...
                <?php for ($i = 0; $i < count($occupations); $i++) :  ?>
                <div class="w3-container">
                    <h5 class="w3-opacity"><b><?php echo $occupations[$i]["name"]; ?></b></h5>
                    <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $occupations[$i]["started"]; ?> -
                    <?php
                    if ($occupations[$i]["ended"]) {
                        echo $occupations[$i]["started"];
                    } else {
                        echo '<span
                    ...
                    <p><?php echo $occupations[$i]["about"]; ?></p>
                    <hr>
                </div>
                <?php endfor; ?>
            </div>
